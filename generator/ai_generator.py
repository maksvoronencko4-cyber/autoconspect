    ...
    def __init__(self, api_key: str = None):
        ...
        if api_key:
            try:
                ...
                # Используем gemini-pro вместо gemini-1.5-flash
...
## ГЛАВА 1. [НАЗВАНИЕ]
### 1.1 [Подраздел]
[Содержательный текст с фактами]
...
2. [Автор. Название. Год]

Пиши содержательно с реальными фактами!""",

            "conspect": f"""Напиши конспект на тему: "{topic}"
...
Пиши реальную информацию!""",

            "doklad": f"""Напиши доклад на тему: "{topic}"
...
Пиши интересно!""",
            ...
            "question": f"""Ответь на вопрос: "{topic}"
